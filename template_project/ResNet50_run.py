...
from model import ResNet50Binary  # Import the ResNet50Binary model
...
def main():
    ...
    for fold in range(k_folds):
        ...
        model = ResNet50Binary().to(device)  # Use ResNet50Binary model
    ...
    best_model = ResNet50Binary().to(device)  # Use ResNet50Binary model
    ...
    log_info = {
        ...
        "Model Used": "ResNet50Binary",  # Updated model name
